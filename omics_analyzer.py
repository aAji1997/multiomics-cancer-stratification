...
if __name__ == "__main__":
    ...
    # Example 1: Basic survival plots with top variable genes
    # analyzer.plot_omics_survival(cancer_type='colorec', data_type='rnaseq', n_top_genes=6)
    
    # Example 2: Kaplan-Meier survival analysis by gene expression
    ...
    # Example 3: Kaplan-Meier with quartile split
    # analyzer.plot_kaplan_meier_by_gene(
    #     cancer_type='colorec', 
    #     data_type='rnaseq',
    #     genes=['TP53', 'APC', 'KRAS'],
    ...
    # Example 4: Methylation data with optimal threshold
    # analyzer.plot_kaplan_meier_by_gene(
    #     cancer_type='colorec', 
